...
var AutoComplete = _react2.default.createClass({
  ...
  propTypes: {
     ...
     */
    maxSearchResult: _react2.default.PropTypes.number,
  ...
  render: function render() {
    ...
    var requestsList = [];
    var maxSearchResult = this.props.maxSearchResult;
    ...
    try {
      for (var _iterator = this.props.dataSource[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
