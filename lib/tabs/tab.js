...
var Tab = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['label', 'onActive', 'onTouchTap', 'selected', 'style', 'tabIndex', 'value', 'width']);
    ...
    var colorStyleMerge = this.mergeStyles(styles, style && style.color ? { color: selected ? style.color : _colorManipulator2.default.fade(style.color, 0.6) } : {});
