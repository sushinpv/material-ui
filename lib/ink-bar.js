...
var InkBar = _react2.default.createClass({
  ...
  propTypes: {
    ...
    moveBarLeft: _react2.default.PropTypes.bool.isRequired,
  ...
  render: function render() {
    ...
    var moveBarLeft = _props.moveBarLeft;
    var style = _props.style;

    var other = _objectWithoutProperties(_props, ['color', 'left', 'right', 'moveBarLeft', 'style']);
