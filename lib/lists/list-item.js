...
var ListItem = _react2.default.createClass({
  ...
  _createDisabledElement: function _createDisabledElement(styles, contentChildren) {
    ...
    return _react2.default.createElement('div', { style: this.prepareStyles(mergedDivStyles) }, contentChildren);
  },
  _createLabelElement: function _createLabelElement(styles, contentChildren) {
    ...
    return _react2.default.createElement('label', { style: this.prepareStyles(mergedLabelStyles) }, contentChildren);
  },
